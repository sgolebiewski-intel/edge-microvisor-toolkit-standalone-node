...
The above script is the main service script that monitors the bridge network. Below is the helper script
`network_config.sh` that should also be placed in the `user-apps/scripts/management/` directory.
